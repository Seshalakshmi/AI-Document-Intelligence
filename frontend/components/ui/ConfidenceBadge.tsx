...
export const ConfidenceBadge: React.FC<{ value: number | null }> = ({ value }) => {
  if (value == null) {
    return (
      <div className="inline-flex items-center px-2 py-1 text-xs font-medium rounded bg-slate-100 text-slate-500">
        Not scored
      </div>
    )
  }
