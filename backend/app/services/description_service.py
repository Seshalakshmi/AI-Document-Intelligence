        ...
        messages=[
            {
                "role": "system",
                "content": (
                    "Write ONE concise but descriptive sentence, max 35 words. "
                    "Include important facts when present: document type, supplier/customer, date, total amount, currency, purpose, or destination. "
